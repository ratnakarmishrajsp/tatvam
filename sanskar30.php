...
<head>
  ...
  <link rel="stylesheet" href="styles-sanskar.css?v=2.2">
...
<body>
        ...
        <div class="bundle-stage">
          ...
          <div class="book-mockup" title="SANSKAR 30 • 30 Days of Good Habits, Strong Values & Happy Growing">
            <div class="book-front">
              <img src="assets/ebook-cover.jpg?v=2.2" alt="SANSKAR 30 Ebook Cover" class="book-cover-img" loading="eager" />
        ...
        <div class="bundle-card featured">
          ...
          <div>
            <div class="bundle-card-header" style="align-items: center; gap: 14px;">
              <img src="assets/ebook-cover.jpg?v=2.2" alt="SANSKAR 30 eBook" style="width: 52px; height: 78px; object-fit: cover; border-radius: 4px; box-shadow: -2px 4px 12px rgba(0,0,0,0.25); border: 1.5px solid rgba(217, 119, 6, 0.35); flex-shrink: 0;" />
              <div>
  ...
  <div class="preview-panel" id="tab-cover" style="display: block; width: 100%;">
    <div class="cover-showcase-container">
      <div class="cover-showcase-image-box">
        <img src="assets/ebook-cover.jpg?v=2.2" alt="SANSKAR 30 Full Ebook Cover" loading="lazy" />
      </div>
      <div class="cover-showcase-details">
        ...
        <div style="margin-top: 10px;">
          <a href="#pricing" class="btn btn-primary" style="padding: 10px 22px; font-size: 14.5px;">
            यह बंडल अभी डाउनलोड करें — ₹199 ➔
          </a>
        </div>
      </div>
    </div>
  ...
  <script src="script-sanskar.js?v=2.2"></script>
</body>
</html>
