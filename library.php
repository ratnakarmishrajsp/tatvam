        ...
        <div class="nav-glass">
            ...
            <nav class="nav-links">
                ...
                <div class="nav-dropdown">
                    <a href="library.php" class="nav-link dropdown-trigger" style="color: var(--color-gold);">E-Books <i data-lucide="chevron-down" class="dropdown-icon" style="color: var(--color-gold); opacity: 1;"></i></a>
                    <div class="dropdown-menu">
                        <a href="library.php" class="dropdown-item active">All E-Books</a>
